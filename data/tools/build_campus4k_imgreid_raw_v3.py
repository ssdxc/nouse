...
def main():
    ...
    train_feats_body = osp.join(root, 'features', 'fast-reid', 't_feats_body.npz')
    query_feats_body = osp.join(root, 'features', 'fast-reid', 'q_feats_body.npz')
    gallery_feats_body = osp.join(root, 'features', 'fast-reid', 'g_feats_body.npz')
    train_dir_face = osp.join(root, 'features', 'face/retina_arcface_full', 'train')
    query_dir_face = osp.join(root, 'features', 'face/retina_arcface_full', 'query')
    gallery_dir_face = osp.join(root, 'features', 'face/retina_arcface_full', 'gallery')
    ...
    save_root = '/data/xieqk/data/campus4k/exp_imgreid/megcn/v3_body_retina_full_n300/'
