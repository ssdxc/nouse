...
def main():
    ...
    # save_root = '/data/xieqk/data/VC-Clothes/exp/graph/v2_body_retina0.7_numpy/'
    save_root = '/data/xieqk/data/VC-Clothes/exp/graph/v2_body_retina0.7_torch/'
...
def feats_select(face_dict):
    bboxs, face_feats = face_dict['bboxs'], face_dict['feats']
    if len(bboxs) > 0:
