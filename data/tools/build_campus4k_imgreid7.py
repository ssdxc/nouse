...
def main():
    root = '/data4/xieqk/model'
    dataset = 'campus4k-imgreid7'
    train_feats_body = osp.join(root, 'fast-reid', dataset, 't_feats_body.npz')
    query_feats_body = osp.join(root, 'fast-reid', dataset, 'q_feats_body.npz')
    gallery_feats_body = osp.join(root, 'fast-reid', dataset, 'g_feats_body.npz')
    train_dir_face = osp.join(root, 'arcface_torch', 'checkpoint', dataset, 'train')
    query_dir_face = osp.join(root, 'arcface_torch', 'checkpoint', dataset, 'query')
    gallery_dir_face = osp.join(root, 'arcface_torch', 'checkpoint', dataset, 'gallery')
    ...
    save_root = '/data/xieqk/data/campus4k-imgreid/{}/exp/fastreid_cosface_n300/'.format(dataset)
