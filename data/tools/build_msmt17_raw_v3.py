...
def main():
    ...
    save_root = '/data/xieqk/data/msmt17/exp/megcn/v3_body_retina_full_n300_torch_demo/'
    # save_root = '/data/xieqk/data/msmt17/exp/megcn/v3_body_retina_0.7_n300_torch/'
