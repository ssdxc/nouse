...
def main():
    root = '/data/xieqk/data/campus4k-imgreid/campus4k-imgreid'
    reid_model = 'bot'
    face_model = 'cosface_r100'
    ...
    save_root = '/data/xieqk/data/campus4k-imgreid/campus4k-imgreid/exp/bot_cosface_n200/'
...
def get_face_head_feats(imgnames, dir_face):
    ...
    for imgname in tqdm(imgnames):
        ...
        # print(osp.exists(json_path_face), json_path_face)
