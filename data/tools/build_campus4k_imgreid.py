...
def main():
    root = '/data2/xieqk/data/campus4k-imgreid/campus4k-imgreid'
    reid_model = 'bot'
    # face_model = 'cos100_d0.9'
    face_model = 'retina_arcface_full'
    ...
    save_root = '/data2/xieqk/data/campus4k-imgreid/campus4k-imgreid/exp/fastreid_arcface_n500/'
