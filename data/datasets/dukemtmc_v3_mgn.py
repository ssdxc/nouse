...
from ..build_graph_v3_mgn import GraphDataset_v3_mgn
from utils import mkdir_if_missing

import sys 

class DukeMTMC_v3_mgn(object):
    ...
    def process_dir(self, graph_dir):
        graph_data = GraphDataset_v3_mgn(graph_dir, self.nodes_num, self.k, self.transform, self.pre_transform)
        return graph_data
