...
from ..build_graph_v3_v1 import GraphDataset_v3_v1
from utils import mkdir_if_missing

import sys 

class VC_Clothes_v3_v1(object):
    ...
    def process_dir(self, graph_dir):
        graph_data = GraphDataset_v3_v1(graph_dir, self.nodes_num, self.k, self.transform, self.pre_transform)
        return graph_data
