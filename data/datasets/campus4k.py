...
class Campus4K(object):

    def __init__(self, root='', nodes_num=50, k=10, transform=None, pre_transform=None):
        self.root = root
        self.k = k
        ...
        self.graph_train_dir = osp.join(root, 'graph_data_v2', 'train')
        self.graph_test_dir = osp.join(root, 'graph_data_v2', 'test')
