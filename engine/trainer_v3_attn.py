...
class Trainer_v3_attn(object):
    ...
    def forward(self, batch_graph_body, batch_graph_face):
        ...
        scores = self.model(batch_graph_body, batch_graph_face, batch_graph_body.batch)
    ...
    def test(self):
        ...
        with torch.no_grad():
            for i in tqdm(range(len(self.test_data))):
                ...
                scores = self.model(query_body, query_face, batch_vec=None).tolist()
